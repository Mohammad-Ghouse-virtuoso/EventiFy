    ...
    <section className={`w-full py-14 sm:py-16 ${className}`} aria-labelledby="hiw-title">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          {steps.map((s, i) => (
            <div key={i} className="rounded-xl border border-gray-100 bg-white p-5 sm:p-6 hover:shadow-md transition-shadow">
              {/* Doodle/Icon */}
              <div className="mb-4 flex items-center">
                <div
                  className="h-12 w-12 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 flex items-center justify-center mr-3 overflow-hidden"
                  role="img"
