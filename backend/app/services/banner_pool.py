"""
Shared banner image pool service for event banners.
Maps event categories to curated Unsplash image pools.
"""
import random
...
def get_image_for_category(category: str) -> str:
    ...
    Args:
        category: Event category (e.g., "art", "food", "sports")
        
    Returns:
        str: Random Unsplash image URL from the category pool
    """
...
def get_all_categories() -> list[str]:
    ...
    return list(CATEGORY_IMAGE_POOLS.keys())
